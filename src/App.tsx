...
>>>>>>> b5bfd99 (Initial commit)
        ...
        <section id="contact" className="py-32">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form className="space-y-8 bg-white p-10 rounded-2xl shadow-xl gradient-border">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 input-gradient-border"
              ...
              <button
                type="submit"
                className="w-full button-gradient text-white py-4 px-8 rounded-lg text-lg font-semibold shadow-lg shadow-indigo-500/25 hover:shadow-xl hover:shadow-indigo-500/40 transition-all duration-300 flex items-center justify-center"
              >
