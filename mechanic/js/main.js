...
if (contactForm) {
  contactForm.addEventListener('submit', function(e) {
    ...
    // Form data object for sending to server
    const formData = {
      name,
      email,
      phone,
    ...
    showFormMessage('Thank you! Your appointment request has been submitted successfully. We will contact you shortly.', 'success');
